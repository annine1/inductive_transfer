...
class Config(object):
    ...
    def alpha(self) -> float:
        return self._get_value_verbose("alpha")  

    @property
    def bw(self) -> float:
        return self._get_value_verbose("bw")  
    
    @property
    def std(self) -> float:
        return self._get_value_verbose("std")
    @property
    def std1(self) -> float:
        return self._get_value_verbose("std1")  
    
    @property
    def mu(self) -> float:
        return self._get_value_verbose("mu")
    
    @property
    def mu1(self) -> float:
        return self._get_value_verbose("mu1")
    
    @property
    def perc_mask(self) -> float:
        return self._get_value_verbose("perc_mask")
    
    @property
    def block_size(self) -> int:
        return self._get_value_verbose("block_size")
    
    @property
    def n_Bootstrap(self) -> int:
        return self._get_value_verbose("n_Bootstrap")
    
    @property
    def lower_bound(self) -> int:
        return self._get_value_verbose("lower_bound")
    
    @property
    def upper_bound(self) -> int:
        return self._get_value_verbose("upper_bound")
    
    @property
    def window_ratio(self) -> float:
        return self._get_value_verbose("window_ratio")
    
    @property
    def scales(self) -> list:
        return self._get_value_verbose("scales")
    ...
    def eval_epoch(self) -> int:
        return self._get_value_verbose("eval_epoch")
    ...
    @property
    def p(self) -> float:
        return self._get_value_verbose("p")    
    ...
    @property
    def number_of_basins1(self) -> int:
        return self._get_value_verbose("number_of_basins1")

    @number_of_basins1.setter
    def number_of_basins1(self, num_basins: int):
        self._cfg["number_of_basins1"] = num_basins    
    ...
    # @property
    # def validation_basin_file1(self) -> Path:
    #     return self._get_value_verbose("validation_basin_file1")
